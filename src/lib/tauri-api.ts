...
export const api = {
  ...
  calibrateOpenclawConfig: (mode = 'inherit') => { invalidate('read_openclaw_config', 'check_installation', 'list_backups', 'get_services_status', 'get_status_summary'); return invoke('calibrate_openclaw_config', { mode }) },
  ...
  listModelTools: () => invoke('list_model_tools'),
  applyModelToTool: (toolId, modelInfo) => { invalidate('read_openclaw_config', 'read_panel_config'); return invoke('apply_model_to_tool', { toolId, modelInfo }) },
  restoreToolModelConfig: (toolId) => { invalidate('read_openclaw_config', 'read_panel_config'); return invoke('restore_tool_model_config', { toolId }) },

  // Codex engine
  codexStatus: () => invoke('codex_status'),
  codexLaunchApp: () => invoke('codex_launch_app'),
  codexRunOnce: (prompt) => invoke('codex_run_once', { prompt }),

  // CodeWhale engine
  codewhaleStatus: () => invoke('codewhale_status'),
  codewhaleRunOnce: (prompt) => invoke('codewhale_run_once', { prompt }),
