 ...
 */
import { api, invalidate } from '../lib/tauri-api.ts'
import { showConfirm, showUpgradeModal } from '../components/modal.ts'
import { toast } from '../components/toast.ts'
import { runGatewayOperation, setUpgrading, isMacPlatform } from '../lib/app-state.ts'
import { getActiveEngine } from '../lib/engine-manager.ts'
    ...
    <div class="setup-shell">
      <div class="setup-hero">
        <div class="setup-hero-brand">
          <img src="/images/logo-brand.png" alt="智爪平台" class="setup-hero-logo">
          <div class="setup-hero-copy">
            ...
            <div class="setup-hero-site-row">
              <a class="setup-hero-site-link" href="https://ai.iazp.cn" target="_blank" rel="noopener noreferrer" title="https://ai.iazp.cn">
                ${icon('link', 14)}
                <span class="setup-hero-site-label">${t('setup.officialWebsite')}</span>
                <span class="setup-hero-site-value">ai.iazp.cn</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div style="margin-top:var(--space-sm);padding:10px 12px;background:var(--bg-tertiary);border-radius:var(--radius-sm);font-size:var(--font-size-xs);color:var(--text-secondary);line-height:1.6">
          ...
          ${isMacPlatform()
            ? `${t('setup.macNodeHint')}<br>
               <code style="background:var(--bg-secondary);padding:2px 6px;border-radius:3px;user-select:all">open /Applications/智爪平台.app</code>`
            : `${t('setup.winNodeHint')}`
          }
      ...
      <div style="display:flex;gap:var(--space-sm);margin-bottom:var(--space-sm)">
        <label class="setup-source-option" style="flex:1;cursor:pointer">
          ...
          <div>
            ...
            <div style="font-size:var(--font-size-xs);color:var(--text-tertiary)">内置 OpenClaw 中文增强运行时</div>
          </div>
        </label>
        <label class="setup-source-option" style="flex:1;cursor:pointer">
        ...
        <div class="setup-help-content">
          ...
          ${isWin ? `
            <div class="setup-help-block">
              ...
              <code class="setup-help-code">curl -fsSL https://ai.iazp.cn/raw/main/deploy.sh | bash</code>
              <div class="setup-help-copy">${t('setup.domesticMirror')} <code>curl -fsSL https://ai.iazp.cn/raw/main/deploy.sh | bash</code></div>
          ...
          <div class="setup-help-block">
            ...
            <code class="setup-help-code">curl -fsSL https://ai.iazp.cn/raw/main/deploy.sh | bash</code>
            <div class="setup-help-copy">${t('setup.domesticMirrorShort')} <code>curl -fsSL https://ai.iazp.cn/raw/main/deploy.sh | bash</code></div>
          </div>
          <div class="setup-help-block">
