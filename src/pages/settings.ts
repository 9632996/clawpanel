...
import { t, getLang, setLang, getAvailableLangs, onLangChange } from '../lib/i18n.ts'
import { isMacPlatform, runGatewayOperation } from '../lib/app-state.ts'
...
function effectiveDockerImage(cfg) {
  return (cfg?.dockerDefaultImage || '').trim() || '1186258278/openclaw'
}
