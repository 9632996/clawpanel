...
export default {
  ...
  getRoutes() {
    return [
      // Hermes 专属页面（/h/ 前缀）
      { path: '/h/setup', loader: () => import('./pages/setup.ts') },
      { path: '/h/dashboard', loader: () => import('./pages/dashboard.ts') },
      { path: '/h/chat', loader: () => import('./pages/chat.ts') },
      { path: '/h/group-chat', loader: () => import('./pages/group-chat.ts') },
      { path: '/h/oauth', loader: () => import('./pages/oauth.ts') },
      { path: '/h/files', loader: () => import('./pages/files.ts') },
      { path: '/h/sessions', loader: () => import('./pages/sessions.ts') },
      { path: '/h/logs', loader: () => import('./pages/logs.ts') },
      { path: '/h/usage', loader: () => import('./pages/usage.ts') },
      { path: '/h/skills', loader: () => import('./pages/skills.ts') },
      { path: '/h/memory', loader: () => import('./pages/memory.ts') },
      { path: '/h/cron', loader: () => import('./pages/cron.ts') },
      { path: '/h/extensions', loader: () => import('./pages/extensions.ts') },
      { path: '/h/gateways', loader: () => import('./pages/gateways.ts') },
      { path: '/h/profiles', loader: () => import('./pages/profiles.ts') },
      { path: '/h/kanban', loader: () => import('./pages/kanban.ts') },
      { path: '/h/lazy-deps', loader: () => import('./pages/lazy-deps.ts') },
      { path: '/h/services', loader: () => import('./pages/services.ts') },
      { path: '/h/config', loader: () => import('./pages/config.ts') },
      { path: '/h/channels', loader: () => import('./pages/channels.ts') },
      { path: '/h/env', loader: () => import('./pages/env-editor.ts') },
      // 共用页面（引擎无关）
