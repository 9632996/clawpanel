 ...
 * 侧边导航栏
 */
import { navigate, getCurrentRoute, reloadCurrentRoute } from '../router.ts'
import { toggleTheme, getTheme } from '../lib/theme.ts'
import { isOpenclawReady } from '../lib/app-state.ts'
import { api } from '../lib/tauri-api.ts'
import { toast } from './toast.ts'
const APP_VERSION = typeof __APP_VERSION__ !== 'undefined' ? __APP_VERSION__ : '0.0.0'
import { t, getLang, setLang, getAvailableLangs } from '../lib/i18n.ts'
import { isFeatureAvailable } from '../lib/feature-gates.ts'
import { getKernelSnapshot } from '../lib/kernel.ts'
import { triggerKernelUpgrade } from '../lib/kernel-upgrade.ts'
import { getActiveEngine, getActiveEngineId, listEngines, needsInitialEngineChoice, isEngineSetupDeferred, switchEngine, onEngineChange } from '../lib/engine-manager.ts'
  ...
  let html = `
    <div class="sidebar-header">
      <div class="sidebar-logo">
        <img src="/images/logo.png" alt="智爪平台">
      </div>
      <span class="sidebar-title">智爪平台</span>
  ...
  html += `
    <div class="sidebar-footer">
      ...
      <div class="sidebar-meta">
        <a href="https://ai.iazp.cn" target="_blank" rel="noopener" class="sidebar-link">ai.iazp.cn</a>
