...
export default {
  ...
  linkWebsite: _('智爪产品官网', 'Product Website', '智爪產品官網'),
  ...
  domesticMirrorHint: _('如需反馈问题或获取商业支持，请通过产品官网联系我们。', 'For feedback or commercial support, contact us through the product website.', '如需反饋問題或取得商業支援，請透過產品官網聯絡我們。'),
  ...
  companyDesc: _('我们长期维护 OpenClaw 相关汉化与产品化能力，提供 AI Agent 产品、企业部署和定制开发服务。', 'We maintain OpenClaw localization and productization capabilities, and provide AI Agent products, enterprise deployment, and custom development services.', '我們長期維護 OpenClaw 相關漢化與產品化能力，提供 AI Agent 產品、企業部署和定制開發服務。'),
