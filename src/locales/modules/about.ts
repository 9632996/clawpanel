...
export default {
  ...
  desc: _('智爪平台版本和项目信息', 'Product version and project info', '智爪平台版本和項目資訊', '製品バージョンとプロジェクト情報', '제품 버전 및 프로젝트 정보', 'Thông tin phiên bản và dự án của sản phẩm', 'Información de versión y proyecto del producto', 'Informações de versão e projeto do produto', 'Информация о версии и проекте продукта', 'Informations de version et de projet du produit', 'Produktversions- und Projektinformationen'),
  ...
  techStack: _('智爪平台基于 Tauri v2 构建，前端 Vanilla JS + Vite，后端 Rust。', 'Built with Tauri v2, Vanilla JS + Vite frontend, and Rust backend.', '智爪平台基於 Tauri v2 構建，前端 Vanilla JS + Vite，後端 Rust。', 'Tauri v2、Vanilla JS + Vite フロントエンド、Rust バックエンドで構築されています。'),
  copyright: _('© 2026 AI作品 · 智爪平台', '© 2026 AI作品 · Zhizhua AI Workbench', '© 2026 AI作品 · 智爪平台'),
  ...
  versionAvailable: _('智爪平台 v{version} 可用', 'Version v{version} available', '智爪平台 v{version} 可用', 'v{version} が利用可能です', 'v{version} 사용 가능', 'Phiên bản v{version} đã có sẵn'),
  ...
  projectClawPanel: _('智爪平台产品基座，Tauri v2 桌面应用', 'Product workbench base built with Tauri v2', '智爪平台產品基座，Tauri v2 桌面應用'),
