...
export default {
  ...
  qtcoolDesc: _('智爪工具入口提供的模型服务，可使用内置授权或你自己的 API Key', 'Model service from the Zhizhua tool portal. Use the built-in authorization or your own API key.', '智爪工具入口提供的模型服務，可使用內置授權或你自己的 API Key'),
  ...
  qtcoolInstructions: _('如需查看额度、补充授权或管理模型服务，请前往 <a>智爪工具入口</a>。', 'Open the <a>Zhizhua tool portal</a> to view credits, add authorization, or manage the model service.', '如需查看額度、補充授權或管理模型服務，請前往 <a>智爪工具入口</a>。'),
