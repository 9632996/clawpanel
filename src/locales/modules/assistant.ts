...
export default {
  ...
  defaultName: _('智爪助手', 'Assistant', '智爪助手', 'AI アシスタント', 'AI 어시스턴트', 'Trợ lý AI', 'Asistente IA', 'Assistente IA', 'ИИ-ассистент', 'Assistant IA', 'KI-Assistent'),
  ...
  qtcoolDesc: _('智爪工具入口内置的模型服务，可配合构建器注入的客户授权额度直接使用', 'Model service built into the Zhizhua tool portal. It can use customer credits injected by the builder.', '智爪工具入口內置的模型服務，可配合構建器注入的客戶授權額度直接使用'),
  ...
  qtcoolInstructions: _('正式客户版会由构建器自动注入授权额度；如需测试或补充额度，请前往 <a>智爪工具入口</a>。', 'Customer builds receive authorized credits from the builder. For tests or additional credits, open the <a>Zhizhua tool portal</a>.', '正式客戶版會由構建器自動注入授權額度；如需測試或補充額度，請前往 <a>智爪工具入口</a>。'),
  ...
  qtcoolSyncDesc: _('将当前 AI作品模型服务配置同步到 OpenClaw 全局配置', 'Sync current AI作品 Model Service config to OpenClaw global config', '將目前 AI作品模型服務設定同步到 OpenClaw 全域設定'),
  qtcoolSyncTo: _('同步到 OpenClaw', 'Sync to OpenClaw'),
  qtcoolSyncToDesc: _('将 AI作品模型服务的 API 配置写入 OpenClaw 全局配置文件', 'Write AI作品 Model Service API config to OpenClaw global config file', '將 AI作品模型服務的 API 設定寫入 OpenClaw 全域設定檔案'),
  ...
  qtcoolNoProvider: _('OpenClaw 中没有找到 AI作品模型服务配置', 'AI作品 Model Service config not found in OpenClaw', 'OpenClaw 中沒有找到 AI作品模型服務設定'),
  ...
  guideTitle: _('这是智爪平台内置的 AI 助手', 'This is the built-in AI assistant in the workbench', '這是智爪平台內置的 AI 助手'),
