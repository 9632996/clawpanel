...
export default {
  ...
  testTitle: _('智爪多智能体工作台测试通知', 'Workbench Test', '智爪多智能體工作台測試通知', 'ワークベンチのテスト通知', '워크벤치 테스트 알림', 'Thông báo thử Workbench', 'Prueba de Workbench', 'Teste da Workbench', 'Тест рабочей среды', 'Test de l’atelier', 'Workbench-Test'),
