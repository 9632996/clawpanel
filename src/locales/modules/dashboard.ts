...
export default {
  ...
  onboardingDesc: _('完成下面几步，就能开始使用工作台了', 'Finish these steps to start using the workbench', '完成下面幾步，就能開始使用工作台了', '以下のステップを完了するとワークベンチが使えます', '아래 단계를 완료하면 워크벤치를 사용할 수 있습니다', 'Hoàn tất các bước dưới để bắt đầu sử dụng workbench', 'Completa estos pasos para empezar a usar el workbench', 'Conclua estes passos para começar a usar o workbench', 'Выполните эти шаги, чтобы начать пользоваться рабочей средой', 'Effectuez ces étapes pour commencer à utiliser l’atelier', 'Schließen Sie diese Schritte ab, um die Workbench zu verwenden'),
  ...
  onboardingAllDone: _('🎉 全部搞定！开始使用你的工作台吧', '🎉 All done! Enjoy your workbench', '🎉 全部搞定！開始使用你的工作台吧', '🎉 すべて完了！ワークベンチをお楽しみください', '🎉 모두 완료! 이제 워크벤치를 사용하세요', '🎉 Hoàn tất tất cả! Hãy bắt đầu dùng workbench', '🎉 ¡Todo listo! Disfruta tu workbench', '🎉 Tudo pronto! Aproveite seu workbench', '🎉 Всё готово! Пользуйтесь рабочей средой', '🎉 Tout est prêt ! Profitez de votre atelier', '🎉 Alles erledigt! Viel Spaß mit Ihrer Workbench'),
