...
export default {
  ...
  headerTitle: _('欢迎使用智爪多智能体工作台', 'Welcome to the AI Workbench', '', '智爪多智能体工作台へようこそ', '지다오 AI 워크벤치에 오신 것을 환영합니다', 'Chào mừng đến với AI Workbench', 'Bienvenido al AI Workbench', 'Bem-vindo ao AI Workbench', 'Добро пожаловать в AI Workbench', 'Bienvenue dans AI Workbench', 'Willkommen bei der AI Workbench'),
