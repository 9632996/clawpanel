...
export default {
  ...
  saveHint: _('修改后点击保存，Gateway 会自动重载', 'Click save after changes, Gateway will auto-reload', '修改后点擊儲存，Gateway 會自動重載'),
  ...
  portHint: _('应用通过这个端口连接 Gateway，默认 18789，一般不需要改', 'Apps connect to Gateway via this port. Default 18789, usually no need to change.', '應用通過这個連接埠連線 Gateway，預設 18789，一般不需要改'),
